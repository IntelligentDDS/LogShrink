...
if __name__ == '__main__':
    ...
    for system in systems:
        ...
        compress(system=system, compress_option='gzip', filepath=input_filepath, output_dir=outdir)
    ...
    results_df = pd.Series(results, name='gzip')
    
    results_df.to_csv('../../results/gzip.csv')
