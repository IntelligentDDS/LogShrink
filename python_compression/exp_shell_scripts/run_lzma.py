...
systems = ['Apache']#, 'BGL',  'Hadoop', 'HDFS', 'HealthApp', 'HPC', 'Mac', 'OpenSSH', 'OpenStack', 'Proxifier', 'Spark', 'Zookeeper', 'Linux']
...
if __name__ == '__main__':
    ...
    for system in systems:
        ...
        compress(system=system, compress_option='lzma', filepath=input_filepath, output_dir=outdir)
    ...
    results_df = pd.Series(results, name='lzma')
    
    results_df.to_csv('../../results/lzma.csv')
